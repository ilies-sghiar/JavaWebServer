...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        RenderContentHandler render = new RenderContentHandler();
        PolicyCheckRequestHandler policy = new PolicyCheckRequestHandler(render);
        ExistingContentCheckRequestHandler existing = new ExistingContentCheckRequestHandler(policy);

        WebServer webServer = new WebServer(existing);
